...
public class TransportController {
    ...
    public TransportController(Transport transport, ControlChangeDispatcher messenger) {
        ...
        messenger.register(new Control(TRANSPORT_BUTTON_CC_CHANNEL, LOOP_BUTTON), this::loop);
        messenger.register(new Control(TRANSPORT_BUTTON_CC_CHANNEL, RECORD_BUTTON), this::record);
    }
